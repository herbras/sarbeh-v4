...
import { Player, GameState, SceneProps } from '../../types';
import { BOARD_SIZE, CELL_SIZE, BOARD_OFFSET_X, BOARD_OFFSET_Y, CELL_COLOR_1, CELL_COLOR_2, COLOR_BLACK, COLOR_WHITE, COLOR_HIGHLIGHT, EVENTS, COLOR_BURST } from '../../constants';
